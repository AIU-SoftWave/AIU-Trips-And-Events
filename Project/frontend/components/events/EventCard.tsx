  ...
  return (
    <div className="group bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl border border-white/30 overflow-hidden hover:shadow-2xl hover:bg-white/90 transform hover:scale-[1.02] transition-all duration-300">
      ...
      <div className="p-6 space-y-4">
        ...
        {/* Description */}
        <p className="text-gray-600 leading-relaxed line-clamp-2">{eventData.description}</p>
        ...
        <div className="space-y-3">
          <div className="flex items-center text-gray-700">
            ...
            <span className="font-medium">{formatDate(eventData.startDate)}</span>
          </div>
          ...
          <div className="flex items-center text-gray-700">
            ...
            <span className="font-medium">
              <span className={eventData.availableSeats < 10 ? 'text-red-600 font-bold' : 'text-gray-700'}>
                {eventData.availableSeats}
              </span>
              <span className="text-gray-500"> / {eventData.capacity} seats</span>
            </span>
          </div>
          ...
          <div className="flex items-center text-gray-700">
            ...
            <span className="font-bold text-lg text-gray-900">${eventData.price}</span>
          </div>
        </div>
        ...
        {eventData.availableSeats < 10 && eventData.availableSeats > 0 && (
          <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-xl p-3">
            <div className="flex items-center">
              ...
              <span className="text-sm font-semibold text-orange-800">Only {eventData.availableSeats} seats left!</span>
            </div>
          </div>
        )}
