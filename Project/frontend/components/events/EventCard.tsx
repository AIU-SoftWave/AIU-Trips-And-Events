        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center text-gray-700">
            ...
            <span className="font-medium">
              <span className={event.availableSeats < 10 ? 'text-red-600 font-bold' : 'text-gray-700'}>
        ...
        {event.availableSeats < 10 && event.availableSeats > 0 && (
          <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-xl p-3">
            <div className="flex items-center">
              ...
              <span className="text-sm font-semibold text-orange-800">Only {event.availableSeats} seats left!</span>
            </div>
          </div>
        )}
